...
Synthesize these visual properties and stylistic DNA into your generated prompt string so that a new AI image generation from it produces icons with a matching style.`;
  ...
  const defaultTemplateGeometries = {
    metal: [
      ...
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1600, fontSize: 135, fontFamily: 'Outfit', fill: '#12382b', text: 'METAL' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1750, fontSize: 60, fontFamily: 'Outfit', fill: '#12382b', text: '[COUNT] LINE ICONS' },
      { id: 'badgeBg', type: 'rect', name: 'Bottom Accent Box', x: 0, y: 1950, w: 1600, h: 650, radius: 0, fill: '#12382b' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2300, fontSize: 84, fontFamily: 'Outfit', fill: '#ffffff', text: '[COUNT] LINE ICONS' },
    ...
    accounting: [
      ...
      { id: 'featIcon', type: 'featured', name: 'Featured Preview Icon', x: 180, y: 180, w: 1240, h: 1240 },
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1600, fontSize: 130, fontFamily: 'Outfit', fill: '#1c1917', text: 'ACCOUNTING' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1750, fontSize: 60, fontFamily: 'Outfit', fill: '#78350f', text: '[COUNT] EDITABLE STROKE' },
      { id: 'badgeBg', type: 'rect', name: 'Bottom Accent Box', x: 0, y: 1950, w: 1600, h: 650, radius: 0, fill: '#f95738' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2300, fontSize: 84, fontFamily: 'Outfit', fill: '#ffffff', text: '[COUNT] STROKE ICONS' },
    ...
    clipboard: [
      ...
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1640, fontSize: 130, fontFamily: 'Outfit', fill: '#0f172a', text: 'CLIPBOARD' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1780, fontSize: 60, fontFamily: 'Outfit', fill: '#0369a1', text: '[COUNT] LINE ICONS' },
      { id: 'badgeBg', type: 'rect', name: 'Orange Accent Badge', x: 340, y: 1940, w: 920, h: 180, radius: 90, fill: '#ea580c' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2040, fontSize: 68, fontFamily: 'Outfit', fill: '#ffffff', text: 'LINE ICONS' },
      { id: 'rightBg', type: 'rect', name: 'Right Panel BG', x: 1600, y: 0, w: 4400, h: 2600, radius: 0, fill: '#ffffff' },
    ...
    document: [
      ...
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1690, fontSize: 135, fontFamily: 'Outfit', fill: '#ffffff', text: 'DOCUMENT' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1820, fontSize: 68, fontFamily: 'Outfit', fill: '#ef4444', text: 'ICONS · VECTOR SVG' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2300, fontSize: 84, fontFamily: 'Outfit', fill: '#ef4444', text: '[COUNT] ICONS' },
      { id: 'rightBg', type: 'rect', name: 'Right Panel BG', x: 1600, y: 0, w: 4400, h: 2600, radius: 0, fill: '#ffffff' },
      { id: 'iconGrid', type: 'grid', name: 'Icons Grid Area', x: 1680, y: 100, w: 4240, h: 2400, padding: 140, fill: '#27272a' }
    ],
    breakeven: [
      { id: 'leftBg', type: 'rect', name: 'Left Sidebar BG', x: 0, y: 0, w: 1600, h: 2600, radius: 0, fill: '#f8fafc' },
      { id: 'topBanner', type: 'rect', name: 'Top Banner BG', x: 0, y: 0, w: 1600, h: 260, radius: 0, fill: '#2563eb' },
      { id: 'badgeText', type: 'text', name: 'Banner Text', x: 800, y: 165, fontSize: 84, fontFamily: 'Outfit', fill: '#ffffff', text: '[COUNT] ICONS' },
      { id: 'featBg', type: 'rect', name: 'Featured Icon Box BG', x: 200, y: 360, w: 1200, h: 1200, radius: 120, fill: '#e2e8f0' },
      { id: 'featIcon', type: 'featured', name: 'Featured Preview Icon', x: 200, y: 360, w: 1200, h: 1200 },
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1720, fontSize: 110, fontFamily: 'Outfit', fill: '#0f172a', text: 'BREAK EVEN POINT' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1840, fontSize: 58, fontFamily: 'Outfit', fill: '#475569', text: '[COUNT] VECTOR ICONS' },
    ...
    healthcare: [
      ...
      { id: 'featIcon', type: 'featured', name: 'Featured Preview Icon', x: 180, y: 180, w: 1240, h: 1240 },
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1640, fontSize: 130, fontFamily: 'Outfit', fill: '#ffffff', text: 'HEALTHCARE ICON' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1770, fontSize: 62, fontFamily: 'Outfit', fill: 'rgba(255,255,255,0.7)', text: '[COUNT] ICONS · VECTOR SVG' },
      { id: 'badgeBg', type: 'rect', name: 'Count Badge BG', x: 480, y: 2160, w: 640, h: 180, radius: 90, fill: '#ffffff' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2270, fontSize: 68, fontFamily: 'Outfit', fill: '#2a4436', text: '[COUNT] ICONS' },
    ...
    slate: [
      ...
      { id: 'featIcon', type: 'featured', name: 'Featured Preview Icon', x: 180, y: 180, w: 1240, h: 1240 },
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1640, fontSize: 125, fontFamily: 'Outfit', fill: '#ffffff', text: 'SLATE VECTOR ICONS' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1770, fontSize: 62, fontFamily: 'Outfit', fill: 'rgba(255,255,255,0.7)', text: '[COUNT] ICONS · VECTOR SVG' },
      { id: 'badgeBg', type: 'rect', name: 'Count Badge BG', x: 480, y: 2160, w: 640, h: 180, radius: 90, fill: '#38bdf8' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2270, fontSize: 68, fontFamily: 'Outfit', fill: '#0f172a', text: '[COUNT] ICONS' },
    ...
    purple: [
      ...
      { id: 'featIcon', type: 'featured', name: 'Featured Preview Icon', x: 180, y: 180, w: 1240, h: 1240 },
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1640, fontSize: 130, fontFamily: 'Outfit', fill: '#ffffff', text: 'CYBER PURPLE' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1770, fontSize: 62, fontFamily: 'Outfit', fill: 'rgba(255,255,255,0.7)', text: '[COUNT] ICONS · VECTOR SVG' },
      { id: 'badgeBg', type: 'rect', name: 'Count Badge BG', x: 480, y: 2160, w: 640, h: 180, radius: 90, fill: '#c084fc' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2270, fontSize: 68, fontFamily: 'Outfit', fill: '#2e1065', text: '[COUNT] ICONS' },
    ...
    dark: [
      ...
      { id: 'featIcon', type: 'featured', name: 'Featured Preview Icon', x: 180, y: 180, w: 1240, h: 1240 },
      { id: 'titleText', type: 'text', name: 'Title Text', x: 800, y: 1640, fontSize: 130, fontFamily: 'Outfit', fill: '#ffffff', text: 'MINIMAL DARK' },
      { id: 'subText', type: 'text', name: 'Subtitle Text', x: 800, y: 1770, fontSize: 62, fontFamily: 'Outfit', fill: 'rgba(255,255,255,0.7)', text: '[COUNT] ICONS · VECTOR SVG' },
      { id: 'badgeBg', type: 'rect', name: 'Count Badge BG', x: 480, y: 2160, w: 640, h: 180, radius: 90, fill: '#eab308' },
      { id: 'badgeText', type: 'text', name: 'Badge Text', x: 800, y: 2270, fontSize: 68, fontFamily: 'Outfit', fill: '#09090b', text: '[COUNT] ICONS' },
